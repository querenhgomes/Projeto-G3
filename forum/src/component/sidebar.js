    ...
    <div>
      ...
      <Router>
        <Navbar fixed="top" className="text-primary" style={style} expand="lg">
          <Navbar.Toggle
            className="nav ml-auto text-primary"
            aria-controls="basic-navbar-nav"
          />
          <Navbar.Collapse
            className="nav mx-auto text-primary"
            id="basic-navbar-nav"
          >
            <Nav
              activeKey="/home"
              onSelect={(selectedKey) => setColor("white")}
              to="/home"
              className="mx-auto text-center"
            >
              <Lonk
                style={
                  Color === "/home" ? { color: "white" } : { color: "grey" }
                }
                to="/home"
              ...
              <Lonk
                style={
                  Color === "/jogos" ? { color: "white" } : { color: "grey" }
                }
                to="/jogos"
                className="navbar-brand"
              >
              ...
              <Lonk
                style={
                  Color === "/negocios" ? { color: "white" } : { color: "grey" }
                }
                to="/negocios"
                className="navbar-brand"
              >
              ...
              <Lonk
                style={
                  Color === "/educacao" ? { color: "white" } : { color: "grey" }
                }
                to="/educacao"
                className="navbar-brand"
              >
              ...
              <Lonk
                style={
                  Color === "/tec" ? { color: "white" } : { color: "grey" }
                }
                to="/tec"
                className="navbar-brand"
              >
